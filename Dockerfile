...
ENV VAR_LINUX_USER="tomcat" \
    VAR_FINAL_COMMAND="JAVA_HOME=\$VAR_JAVA_HOME CATALINA_HOME=\$VAR_CATALINA_HOME CATALINA_OPTS=\$VAR_CATALINA_OPTS JAVA_MAJOR=9 TOMCAT_MAJOR=9 CATALINA_OUT=\$VAR_CATALINA_OUT PATH=\\\"\$PATH:$CONTENTDESTINATION2/bin:$CONTENTDESTINATION1/bin\\\" catalina.sh" \
    VAR_JAVA_HOME="'$CONTENTDESTINATION2'" \
    VAR_CATALINA_HOME="'$CONTENTDESTINATION1'" \
